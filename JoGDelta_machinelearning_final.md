...
The accuracy of this model is 58.32%. The model results can also be plotted as follows:
...
The accuracy of this model is 99.18%. The model results can also be plotted as follows:
...
The accuracy of this model is 95.96%. The model results can also be plotted as follows:
...
The accuracy of the decision tree model was the lowest at 58.32%. The accuracy of the gradient boosting model was 95.96%, and the accuracy of the random forest model was the highest at 99.18%. We will therefore use the model with the greatest accuracy, the random forest model, to predict the classification of the 20 test cases in the "test_data3" file.
